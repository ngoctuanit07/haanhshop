...
//========End cart
	...
	Route::post('/order', 'OrderController@orderProduct')->name('order');


//news
	
	
	Route::get('/tin-tuc', 'NewsController@tintuc')->name('news');
	
	Route::get('/tin-tuc/{name}_{id}.html', 'NewsController@tintucDetail')
