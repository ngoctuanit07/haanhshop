...
<table width="100%" cellpadding="0" cellspacing="0" border="0" id="background-table">
    <tr>
        <td valign="top" class="container-td" align="center">
                        ...
                        <table cellpadding="0" cellspacing="0" border="0">
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0">
                                        <tr>
                                            <td class="email-heading">
                                                <h1>Cảm ơn bạn đã đặt hàng tại   {{ $site_title??"Hà Anh Shop" }}.</h1>
                                                <p>Đơn hàng của bạn đang được chúng tôi đóng gói, dưới đây là chi tiết đơn hàng của bạn.</p>
                                                <h4>Mọi câu hỏi liên quan đến đơn hàng.</h4>
                                                <p>

                                                    <b>Điện thoại:</b>
                                                    <a href="tel:0984350829">0984350829</a><br>
                                                    <b>Email:</b> <a href="mailto:tuannguyen0719@gmail.com">tuannguyen0719@gmail.com</a>
                                                </p>
                                            </td>
                                        </tr>
                                    </table>
                            ...
                            <tr>
                                <td class="body" width="100%" cellpadding="0" cellspacing="0"
                                    style="font-family:Verdana, Arial;box-sizing:border-box;background-color:#ffffff;border-bottom:1px solid #edeff2;border-top:1px solid #edeff2;margin:0;padding:0;width:100%">
                                    <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0"
                                           style="font-family:Verdana, Arial;;box-sizing:border-box;background-color:#ffffff;margin:0 auto;padding:0;width:570px">

                                        <tbody>
                                        <tr>
                                            <td class="content-cell"
                                                style="font-family:Verdana, Arial;,sans-serif;box-sizing:border-box;padding:35px">
                                                @yield('main')
                                            </td>
                                        </tr>
                                        </tbody>
            ...
            <h5 class="closing-text">Thank you, &copy;{{ date('Y') }} {{ $site_title??"Hà Anh Shop" }}. All rights
                reserved.</h5>
        </td>
    </tr>
</table>
