...
<!--//Module meta -->
    ...
    <link rel="apple-touch-icon-precomposed" sizes="144x144"
          href="{{ asset(SITE_THEME_ASSET.'/images/ico/apple-touch-icon-144-precomposed.png')}}">
    <link rel="apple-touch-icon-precomposed" sizes="114x114"
          href="{{ asset(SITE_THEME_ASSET.'/images/ico/apple-touch-icon-114-precomposed.png')}}">
    <link rel="apple-touch-icon-precomposed" sizes="72x72"
          href="{{ asset(SITE_THEME_ASSET.'/images/ico/apple-touch-icon-72-precomposed.png')}}">
    <link rel="apple-touch-icon-precomposed"
          href="{{ asset(SITE_THEME_ASSET.'/images/ico/apple-touch-icon-57-precomposed.png')}}">
    <!--Module header -->
