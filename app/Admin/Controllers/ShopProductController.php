...
//Language
                ...
                foreach ($languages as $key => $language) {
                    ...
                    $form->ckeditor($language->code . '__description', trans('language.admin.description'))->rules('max:300000', ['max' => trans('validation.max')])->default(!empty($langDescriptions->description) ? $langDescriptions->description : null);
					$form->ckeditor($language->code . '__thanhphan', trans('language.admin.thanhphan'))->rules('max:300000', ['max' => trans('validation.max')])->default(!empty($langDescriptions->thanhphan) ? $langDescriptions->thanhphan : null);
					...
					$arrFields[] = $language->code . '__thanhphan';
...
SCRIPT;
            ...
            $form->saving(function (Form $form) use ($languages, &$arrData) {
                ...
                foreach ($languages as $key => $language) {
					...
					$arrData[$language->code]['thanhphan']     = request($language->code . '__content');
